...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<HelloWorldProto.HelloRequest,
      HelloWorldProto.HelloReply> getStreamHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<HelloWorldProto.HelloRequest,
      HelloWorldProto.HelloReply> getStreamHelloMethod() {
    io.grpc.MethodDescriptor<HelloWorldProto.HelloRequest, HelloWorldProto.HelloReply> getStreamHelloMethod;
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(HelloWorldProto.HelloRequest request,
    ...
    /**
     */
    default void streamHello(HelloWorldProto.HelloRequest request,
                             io.grpc.stub.StreamObserver<HelloWorldProto.HelloReply> responseObserver) {
  ...
  public static final class SimpleStub
    ...
    /**
     */
    public void streamHello(HelloWorldProto.HelloRequest request,
                            io.grpc.stub.StreamObserver<HelloWorldProto.HelloReply> responseObserver) {
  ...
  public static final class SimpleBlockingV2Stub
     ...
     * </pre>
     */
    public HelloWorldProto.HelloReply sayHello(HelloWorldProto.HelloRequest request) throws io.grpc.StatusException {
    ...
    public io.grpc.stub.BlockingClientCall<?, HelloWorldProto.HelloReply>
        streamHello(HelloWorldProto.HelloRequest request) {
  ...
  public static final class SimpleBlockingStub
    ...
    /**
     */
    public java.util.Iterator<HelloWorldProto.HelloReply> streamHello(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_STREAM_HELLO:
          serviceImpl.streamHello((HelloWorldProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<HelloWorldProto.HelloReply>) responseObserver);
          break;
        default:
